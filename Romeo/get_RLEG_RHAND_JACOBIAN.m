...
function jacobian=get_RLEG_RHAND_JACOBIAN(q)
    ...
    zero=zeros(3,1);
	jacobian=[cross(z0,pEE-p0), cross(z1,pEE-p1), -cross(z2,pEE-p2), cross(z3,pEE-p3), cross(z4,pEE-p4), cross(z5,pEE-p5), cross(z6,pEE-p6), cross(z8,pEE-p8), cross(z9,pEE-p9), cross(z11,pEE-p11), cross(z12,pEE-p12), zero, zero, zero, zero, zero, zero, zero, zero, zero, zero];
